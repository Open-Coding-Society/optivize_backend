...
CORS(
    flashcard_api,
    resources={r"/*": {"origins": ["http://127.0.0.1:4887", "https://open-coding-society.github.io"]}},
...
class FlashcardAPI:
  ...
  # ✅ Allow credentials
    ...
    def flashcard_options(flashcard_id):
        response = jsonify({})
        response.headers.add("Access-Control-Allow-Origin", "https://open-coding-society.github.io")
